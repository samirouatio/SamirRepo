package com.Battle_Simulation_Game.Speakerman.TitanTvMan.SkibidiToiletWar.MyAdNetworks;
    ...
    public void showBanner(RelativeLayout bannerContainer){
        ...
        maxBanner.setListener(new MaxAdViewAdListener() {
            ...
            public void onAdLoaded(MaxAd maxAd) {
                ...
                maxBanner.setBackgroundColor(ContextCompat.getColor(myActivity,R.color.transparent));
