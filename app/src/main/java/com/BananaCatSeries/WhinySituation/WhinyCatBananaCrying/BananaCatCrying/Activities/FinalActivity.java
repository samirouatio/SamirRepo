...
import com.BananaCatSeries.WhinySituation.WhinyCatBananaCrying.BananaCatCrying.MyClasses.WV_Helpers.AdBlockerChecker;
import com.BananaCatSeries.WhinySituation.WhinyCatBananaCrying.BananaCatCrying.MyClasses.WV_Helpers.AdBlockerHelper;
import com.BananaCatSeries.WhinySituation.WhinyCatBananaCrying.BananaCatCrying.MyClasses.WV_Helpers.MyChrome;
import com.BananaCatSeries.WhinySituation.WhinyCatBananaCrying.BananaCatCrying.MyClasses.WV_Helpers.MyBrowser;
...
import com.BananaCatSeries.WhinySituation.WhinyCatBananaCrying.BananaCatCrying.Useful.RatingBarDialog;
...
//        webView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
    ...
    private void ErrorAndGoBackToMenu() {
        ...
        new Handler().postDelayed(() -> {
            adLoadingPopup.dismiss();
            Toast.makeText(FinalActivity.this, "Something went wrong!", Toast.LENGTH_LONG).show();
